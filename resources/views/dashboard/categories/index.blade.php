                                    ...
                                    <div class="card-body card-dashboard">
                                        <table
                                            ...
                                            <tr>
                                                ...
                                                <th>{{__('admin\categories.sulg')}}  </th>
                                                <th>{{__('admin\categories.is_active')}} </th>
                                                <th>{{__('admin\categories.image')}}  </th>
                                                <th>{{__('admin\categories.options')}} </th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                                        ...
                                                        <td>
                                                            <div class="btn-group" role="group"
                                                                ...
                                                                <a href="{{route('admin.maincategories.edit',[$category->id])}}"
                                                                   ...
                                                                   <form method="post" action ="{{route('admin.maincategories.destroy',[$category->id])}}">
                                                                    @method('delete')
                                                                    @csrf
